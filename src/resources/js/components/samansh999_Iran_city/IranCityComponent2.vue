<template>
    <div class="container">
        ...
        <div class="form-group row">
            <label for="province" class="control-label text-center col-md-3"><span>استان</span><span class="text-danger"> * </span></label>
            <div class="col-md-9">
                <select class="form-control custom-select" name="province" id="province" v-model="province_selected"
                        dir="rtl">
        ...
        <div class="form-group row" v-if="province_selected">
            <label for="cities" class="control-label text-center col-md-3"><span>شهرستان</span><span class="text-danger"> * </span></label>
            <div class="col-md-9">
        ...
        <div class="form-group row" v-if="city_selected">
            <label for="sections" class="control-label text-center col-md-3"><span>بخش</span><span class="text-danger"> * </span></label>
            <div class="col-md-9">
            ...
            <p v-if="section_waiting" class="float-right text-success text-right" v-text="section_message"
               dir="rtl"></p>

        </div>


        <div class="form-group row" v-if="section_selected">
            <label for="towns" class="control-label text-center col-md-3"><span>شهر</span><span class="text-danger">  </span></label>
            <div class="col-md-9">
        ...
        <div class="form-group row" v-if="section_selected">
            <label for="rurals" class="control-label text-center col-md-3"><span>دهستان</span><span class="text-danger">  </span></label>
            <div class="col-md-9">
